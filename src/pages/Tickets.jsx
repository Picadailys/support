...
const Tickets = () => {
    return (
        <section className='ticket-section-holder xui-pos-relative xui-d-flex'>
            <div className='ticket-left xui-pt-1-half xui-pl-1-half'>
                <div className='xui-h-fluid-100 xui-overflow-y-auto box-shadow-1' style={{borderRadius: '16px 0 0 0'}}>
            ...
            <div className='ticket-right xui-pos-relative'>
