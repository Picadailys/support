...
const Dropdown = (props) => {
    ...
    return (
        <div className='xui-pos-relative'>
            ...
            {open && (
                <div ref={menuRef} style={{"left": "-200px", "top": "0"}} className='xui-w-200 xui-max-w-200 xui-bdr-rad-half xui-overflow-y-auto xui-bg-white xui-z-index-1 xui-p-1 xui-box-shadow-2 xui-pos-absolute'>
                    {children}
                </div>
            )}
        </div>
