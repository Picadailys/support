            ...
            <div className="xui-d-flex xui-flex-ai-center">
              ...
              >
                ...
                <p className="xui-opacity-7 xui-mt-half xui-font-sz-75 xui-d-flex xui-flex-ai-center xui-grid-gap-half">
                  ...
                  ></span>
                  <span className="xui-font-sz-70">Available</span>
                </p>
              </div>
            </div>
            {menuItems.map((item, index) => (
              <div key={index} className="xui-mt-2 xui-mb-2 xui-font-sz-85">
                {item.isLink ? (
                  <NavLink
                    to="/"
                    className={`${item.customStyle} xui-text-dc-none xui-d-flex xui-flex-jc-space-between xui-flex-ai-center`}
                  ...
                  <div
                    className={`${item.customStyle} xui-d-flex xui-cursor-pointer xui-flex-jc-space-between xui-flex-ai-center`}
                    onClick={item.dropdown ? toggleDropdown : undefined}
                  >
                    <div className="xui-d-flex xui-flex-ai-center xui-grid-gap-1">
                      <span>{item.icon}</span>
                  ...
                  <div className="xui-px-1-half sub-link-box">
                    {item.subItems.map((subItem, subIndex) => (
                      <NavLink
                        key={subIndex}
                        to={subItem.link}
                        className={`link-box xui-p-half ${({ isActive }) =>
                          isActive ? "active-link" : "grey-color"}`}
                      >
                        <>
          ...
          <div className="content">
            <nav className="xui-navbar xui-d-flex xui-flex-ai-center xui-flex-jc-space-between grey-bg xui-px-1 xui-md-px-2">
              ...
              <div className="xui-d-flex xui-flex-ai-center xui-grid-gap-1-half">
                <Link to={"/dashboard"} className="xui-d-inline-block">
                  <Envelope />
                </Link>
                <Link to={"/dashboard"} className="xui-d-inline-block">
                  <Bell />
